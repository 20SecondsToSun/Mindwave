...
MindwaveParserSerial::MindwaveParserSerial(QObject *parent) : BaseMindwaveParser(parent)
{
    initParser(PARSER_TYPE_PACKETS, NULL);
}

MindwaveParserSerial::~MindwaveParserSerial()
{

}

void MindwaveParserSerial::setConfig(const MindwaveConfig& value)
{
